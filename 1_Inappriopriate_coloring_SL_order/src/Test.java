...
public class Test {
	...
	public static void main(String[] args) throws FileNotFoundException {
		String file = "Test_Graphs/TestGraph2.txt";
		...
		String plik2 = "Test_Graphs/Smallest_quite_difficult_graph_for_SL_order.txt";
		...
		String plik3 = "Test_Graphs/prismatoid.txt";
		...
		String plik4 = "Test_Graphs/Petersen_Graph.txt";
